...
root = Tk()
root.title("짝수/홀수 판정")
root.geometry("300x150+300+200")
root.option_add("*font","System 12")


# 입력, 출력 프레임 - pady(위, 아래) : y축 바깥 여백, padx(좌, 우) : x축 바깥 여백
io_frame = Frame(root)
...
text.grid(row=1, column=1) # row 를 늘리면 아래로 길어지고 column을 늘리면 좌우로 길어짐
...
# TOP, RIGHT, BOTTOM, LEFT  -> 시계방향으로 돌아감
